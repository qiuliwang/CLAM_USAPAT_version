...
class UnalignedDataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        return {'A': A, 'A_paths': A_path, 'A_mask_cell': A_mask_cell, 'A_mask_blood': A_mask_blood, 'A_mask_cell_path': A_mask_cell_path, 'A_mask_blood_path': A_mask_blood_path, 'B': B, 'B_paths': B_path, 'B_mask_cell' : B_mask_cell, 'B_mask_cell_path' : B_mask_cell_path}
