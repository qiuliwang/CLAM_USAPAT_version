...
class CycleGANModel(BaseModel):
    ...
    def forward(self):
        ...
        ave_thres = [61.915, 93.965, 126.0, 157.93, 189.795, 220.08, 239.49]        # CD20
        ...
        ave_thres = [61.78, 93.925, 125.995, 157.81, 188.23, 213.8, 235.96]     # CD20
        ...
        ave_thres = [62.0, 93.98989898989899, 126.0, 157.87878787878788, 189.57575757575756, 220.08080808080808, 235.08080808080808]        # CD20
        B_cell = np.where(B_channel_0 > ave_thres[3], 255.0, 0.0)       # 改动
        ...
        B_channel_0 = np.expand_dims(B_norm_image[:, 0, :, :], 1)
        # ave_thres = [59.849849849849846, 93.49849849849849, 125.84684684684684, 157.7007007007007, 187.95995995995995, 206.8998998998999, 221.3133133133133]
        ave_thres = [61.96969696969697, 93.97979797979798, 126.0, 157.989898989899, 190.0, 221.31313131313132, 236.64646464646464]  # CD20
        B_stain = np.where(B_channel_0 > ave_thres[2], 255.0, 0.0)  # 改动
